...
| `/scanFile?path=/folder/file.txt` | A scanning endpoint that will scan a file using SCAN. A practical example would be to mount a share into the container where you put a file into a folder, call `/scanFile` and let it scan the content.<br/><br/>**example response:**<br/> `{"Status":"FOUND","Description":"Win.Test.EICAR_HDB-1","FileName":"/clamav/tmp/eicar.test"}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
